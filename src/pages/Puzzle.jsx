...
function Puzzle({ setUserId, userId }) {
    ...
    async function getPuzzle() {
        try {
            ...
            if (result.puzzle) {
                ...
                setCheckpoint1(result.puzzle.checkpoint_1)
                setCheckpoint2(result.puzzle.checkpoint_2)
                setCheckpoint3(result.puzzle.checkpoint_3)
                setCheckpoint4(result.puzzle.checkpoint_4)
                setCheckpoint5(result.puzzle.checkpoint_5)
    ...
    return (
        <div className='puzzle-root'>
            ...
            <div style={{ width: '85%', display: 'flex', flexDirection: 'column', gap: '3rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', alignItems: 'center', height: '15%', width: '100vw', justifyContent: 'flex-end' }}>
